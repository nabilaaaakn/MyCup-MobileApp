...
class OrderBrown extends StatefulWidget {
  const OrderBrown({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _OrderBrownState createState() => _OrderBrownState();
}

class _OrderBrownState extends State<OrderBrown> {
  ...
  void _onBrownSelect() {
    setState(() {
      isBrownSelected = !isBrownSelected;
    });
  }

  void _saveOrder() {
    final order = Order(
      productImage: 'images/brown_sugar.png',
      price: 25000,
      productName: 'Brown Sugar Coffee',
            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  width: 172,
                  child: Text(
                    'terbuat dari gula tebu yang dicampur dengan molases.',
                    style: TextStyle(
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: [
                      GestureDetector(
                        onTap: _onBrownSelect,
                        child: Container(
                          width: 150,
                          height: 150,
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('images/brown_sugar.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
