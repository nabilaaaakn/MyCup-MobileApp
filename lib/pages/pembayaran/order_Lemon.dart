...
class OrderLemon extends StatefulWidget {
  const OrderLemon({super.key});
...
class _OrderLemonState extends State<OrderLemon> {
  ...
  void _onLemonSelect() {
    setState(() {
      isLemonSelected = !isLemonSelected;
    });
  }
  ...
  void _saveOrder() {
    final order = Order(
      productId: '1',
      productImage: 'images/image_2641650.png',
      price: 18000,
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: [
                      GestureDetector(
                        onTap: _onLemonSelect,
                        child: Container(
                          width: 150,
                          height: 150,
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('images/image_2641650.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
