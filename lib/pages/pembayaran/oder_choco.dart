...
class OrderChoco extends StatefulWidget {
  const OrderChoco({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _OrderChocoState createState() => _OrderChocoState();
}

class _OrderChocoState extends State<OrderChoco> {
  ...
  void _onChocoSelect() {
    setState(() {
      isChocoSelected = !isChocoSelected;
    });
  }

  void _saveOrder() {
    final order = Order(
      productImage: 'images/image_2551607.png',
      price: 25000,
            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  width: 172,
                  child: Text(
                    'minuman dingin yang dibuat dari choco dengan susu.',
                    style: TextStyle(
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: [
                      GestureDetector(
                        onTap: _onChocoSelect,
                        child: Container(
                          width: 150,
                          height: 150,
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('images/image_2551607.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
