...
class OrderTaro extends StatefulWidget {
  const OrderTaro({super.key});
...
class _OrderLemonState extends State<OrderTaro> {
  ...
  void _saveOrder() {
    final order = Order(
      productId: '4',
      productImage: 'images/image_2682680.png',
      price: 25000,
            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  width: 172,
                  child: Text(
                    'terbuat dari bubuk ubi ungu, susu, dan kopi, dengan rasa manis.',
                    style: TextStyle(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('images/image_2682680.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
