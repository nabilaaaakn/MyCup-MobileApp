...
class OrderThai extends StatefulWidget {
  const OrderThai({super.key});
...
class _OrderLemonState extends State<OrderThai> {
  ...
  void _saveOrder() {
    final order = Order(
      productId: '3',
      productImage: 'images/image_2662585.png',
      price: 25000,
            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  width: 172,
                  child: Text(
                    'Campuran teh hitam, adas manis, kapulaga, gula, bunga jeruk, dan susu.',
                    style: TextStyle(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('images/image_2662585.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
