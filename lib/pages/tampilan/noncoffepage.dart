...
import 'package:mycup_flutter/pages/pembayaran/order_taro.dart';
import 'package:mycup_flutter/pages/pembayaran/order_thai.dart';

class nonCoffeePage extends StatefulWidget {
  const nonCoffeePage({super.key});

  @override
  State<StatefulWidget> createState() => _NonCoffeePageState();
}
                                    ...
                                    showModalBottomSheet(
                                      ...
                                      builder: (context) {
                                        return FractionallySizedBox(
                                          ...
                                          child:
                                              OrderThai(), // Ganti dengan widget halaman lain yang ingin ditampilkan
                                        );
                                      },
                                    );
                                  },
                                      ...
                                      builder: (context) {
                                        return FractionallySizedBox(
                                          heightFactor:
                                              0.762, // Atur tinggi dialog sesuai kebutuhan
                                          child:
                                              OrderTaro(), // Ganti dengan widget halaman lain yang ingin ditampilkan
                                        );
                                      },
                                    );
                                  },
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, '/history_wait');
                        },
                        child: Image.asset(
                          'images/History.png',
                          width: 24,
